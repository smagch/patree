...
func TestDateMatcher(t *testing.T) {
	m := matcherTest{DateMatcher, []matcherTestCase{
		{"0000-01-01", 10, "0000-01-01"},
		{"9999-12-31", 10, "9999-12-31"},
		{"2014-01-01", 10, "2014-01-01"},
		{"1000-12-11/events", 10, "1000-12-11"},
		{"2000-08-08/events", 10, "2000-08-08"},
		{"20000-01-01", -1, ""},
		{"1000-00-01", -1, ""},
		{"1000-13-01", -1, ""},
		{"3007-12-32", -1, ""},
		{"2004-02-31", 10, "2004-02-31"},
		{"----", -1, ""},
		{"0000-00-00", -1, ""},
	}}
	m.test(t)
